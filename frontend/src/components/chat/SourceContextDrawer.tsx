...
export function SourceContextDrawer({
  ...
  return (
    <aside className="fixed inset-y-0 right-0 z-50 flex w-full max-w-md flex-col border-l border-border bg-card p-6 shadow-2xl transition-all sm:w-[450px]">
      {/* Header */}
      ...
      <div className="mt-4 flex-1 space-y-4 overflow-y-auto pr-1">
        ...
        <div className="rounded-xl border-2 border-primary/40 bg-accent/40 p-4 shadow-sm">
